...
def main():
    ...
    parser.add_argument("--model-dir", type=str, default="./my_tiny_chatbot2", help="Répertoire contenant model.pt et config.json")
    parser.add_argument("--tokenizer", type=str, default="../Tokenizer/tokenizer_5k.bin", help="Chemin vers le tokenizer BPE")
